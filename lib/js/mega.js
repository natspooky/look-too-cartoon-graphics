...
function tileCompleted(gallerySize, tileIndex) {
    console.log(gallerySize, tileIndex, localStorage.getItem(`Picross!%${gallerySize}%${tileIndex}`))
    if(localStorage.getItem(`Picross!%${gallerySize}%${tileIndex}`) == 'false' || localStorage.getItem(`Picross!%${gallerySize}%${tileIndex}`)) {
