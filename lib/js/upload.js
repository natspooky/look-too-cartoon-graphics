...
function createImageBuffer(file) {
    ...
    e.onload = () => {
        ...
        //console.log('working')
        img = loadImage(canvas.toDataURL("image/png"), () => {startGame(true); changePage('game', document.getElementById('upload'))})
        document.getElementById('testimage').src = canvas.toDataURL("image/png")
